...
public class Scenario1_Steps extends BaseClass {
    ...
    public void user_launched_the_OI_Shopping_List_app_and_tapped_on_Hamburger_menu_icon_on_left_hand_side_screen() throws Throwable {
    ...
    public void add_the_items_to_list_should_be_added_to_list_and_saved(String Items) throws Throwable {
        driver.findElementById("org.openintents.shopping:id/autocomplete_add_item").sendKeys(Items);
